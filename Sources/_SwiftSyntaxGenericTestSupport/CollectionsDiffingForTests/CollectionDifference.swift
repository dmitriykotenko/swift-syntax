...
public struct CollectionDifferenceForTests<ChangeElement> {
  ...
  public init?<Changes: Collection>(
    ...
    guard CollectionDifferenceForTests<ChangeElement>._validateChanges(changes) else {
      return nil
    }
  ...
  public func inverse() -> Self {
    return CollectionDifferenceForTests(_validatedChanges: self.map { c in
      switch c {
...
/// }
/// ```
extension CollectionDifferenceForTests: Collection {
...
extension CollectionDifferenceForTests.Index: Equatable {
  @inlinable
  public static func == (
    lhs: CollectionDifferenceForTests.Index,
    rhs: CollectionDifferenceForTests.Index
  ) -> Bool {
    return lhs._offset == rhs._offset
  }
}

extension CollectionDifferenceForTests.Index: Comparable {
  @inlinable
  public static func < (
    lhs: CollectionDifferenceForTests.Index,
    rhs: CollectionDifferenceForTests.Index
...
extension CollectionDifferenceForTests.Index: Hashable {
  @inlinable
...
extension CollectionDifferenceForTests.Change: Equatable where ChangeElement: Equatable {}

extension CollectionDifferenceForTests: Equatable where ChangeElement: Equatable {}

extension CollectionDifferenceForTests.Change: Hashable where ChangeElement: Hashable {}

extension CollectionDifferenceForTests: Hashable where ChangeElement: Hashable {}

extension CollectionDifferenceForTests where ChangeElement: Hashable {
  ...
  public func inferringMoves() -> CollectionDifferenceForTests<ChangeElement> {
    ...
    return CollectionDifferenceForTests(_validatedChanges: map({ (change: Change) -> Change in
      switch change {
...
extension CollectionDifferenceForTests.Change: Codable where ChangeElement: Codable {
...
extension CollectionDifferenceForTests: Codable where ChangeElement: Codable {}

extension CollectionDifferenceForTests: Sendable where ChangeElement: Sendable { }
extension CollectionDifferenceForTests.Change: Sendable where ChangeElement: Sendable { }
extension CollectionDifferenceForTests.Index: Sendable where ChangeElement: Sendable { }
